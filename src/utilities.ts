...
// Define a type for generic parameters
...
export function get(endpoint: string, params: Params = {}): Promise<any> {
...
// Returns a Promise to a JSON Object.
export function post(endpoint: string, params: Params = {}): Promise<any> {
